...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(1000)) }
  ...
  describe "GET #show" do
    ...
    it "assigns my post to @sponsored_post" do
      get :show, params: { topic_id: my_topic.id, id: my_post.id }
  ...
  describe "PUT update" do
    it "updates post with expected attributes" do
      ...
      put :update, params: { topic_id: my_topic.id, id: my_post.id, post: { title: new_title, body: new_body, price: new_price } }
